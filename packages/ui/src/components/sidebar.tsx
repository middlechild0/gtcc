  ...
  (
    ...
    const setOpen = React.useCallback(
      (value: boolean | ((value: boolean) => boolean)) => {
        ...
        // biome-ignore lint/suspicious/noDocumentCookie: sidebar state cookie by design
        ...
        <div
          className={cn(
            ...
            isOffcanvasCollapsed &&
              side === "left" &&
              "w-[--sidebar-width] left-[calc(var(--sidebar-width)*-1)]",
            isOffcanvasCollapsed &&
              side === "right" &&
              "w-[--sidebar-width] right-[calc(var(--sidebar-width)*-1)]",
            isIconCollapsed &&
              (variant === "floating" || variant === "inset"
